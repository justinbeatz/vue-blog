      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Ducimus, vero, obcaecati, aut, error quam sapiente nemo saepe quibusdam
              sit excepturi nam quia corporis eligendi eos magni recusandae laborum
              minus inventore?</p>

          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut, tenetur
              natus doloremque laborum quos iste ipsum rerum obcaecati impedit odit
              illo dolorum ab tempora nihil dicta earum fugiat. Temporibus, voluptatibus.</p>
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos, doloribus,
              ...
              ullam ea hic porro optio ratione repellat perspiciatis. Enim, iure!</p>
...
export default {
  ...
  methods: {
    async getPost() {
      try {
        const response = await ApiServices.getPost(this.$route.params.id);
